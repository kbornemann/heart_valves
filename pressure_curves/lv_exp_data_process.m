...
% Rethink
Q_goal_L_per_min = 0.3504; %0.314; 
Q_goal_ml_per_s = Q_goal_L_per_min * 1e3 / 60; 
Q_goal_ml_per_cycle = 2.4; %2.0; %Q_goal_ml_per_s * cycle_duration; 

ejection_fraction_goal = 0.575; %0.493;
end_diastolic_volume = 4.2; %4.0; %Q_goal_ml_per_cycle / ejection_fraction_goal;
...
if two_hill
    ...
    t_shift =  0.05315600095157123
    tau_1 =  0.18700057180944518
    tau_2 =  0.35214911437473473
    m1 =  17.797758376473503
    m2 =  31.043444700309593
