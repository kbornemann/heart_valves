...
% Rethink
Q_goal_L_per_min = 0.314; 
Q_goal_ml_per_s = Q_goal_L_per_min * 1e3 / 60; 
Q_goal_ml_per_cycle = 2.0; %Q_goal_ml_per_s * cycle_duration; 

ejection_fraction_goal = 0.493;
end_diastolic_volume = 4.0; %Q_goal_ml_per_cycle / ejection_fraction_goal;
