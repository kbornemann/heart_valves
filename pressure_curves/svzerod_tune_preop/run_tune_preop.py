...
class optimizer_class():
    ...
    def print_summary(self, targets):
        ...
        for target_name in targets:
            ...
            elif target_name in self.fwd_sim_obj['chambers'][1]['values']:
                print(target_name, "= ", self.fwd_sim_obj['chambers'][1]['values'][target_name])
            elif target_name in self.fwd_sim_obj['boundary_conditions'][2]['bc_values']:
                print(target_name, "= ", self.fwd_sim_obj['boundary_conditions'][2]['bc_values'][target_name])
            elif target_name in self.fwd_sim_obj['boundary_conditions'][3]['bc_values']:
                print(target_name, "= ", self.fwd_sim_obj['boundary_conditions'][3]['bc_values'][target_name])
            elif target_name in self.fwd_sim_obj['boundary_conditions'][4]['bc_values']:
...
def objective_function_free_params(params, opt_instance, targets):
    ...
    for idx,target_name in enumerate(targets):
        ...
        elif target_name in opt_instance.fwd_sim_obj['chambers'][1]['values']:
            opt_instance.fwd_sim_obj['chambers'][1]['values'][target_name] = params[idx]
...
def run_optimization(opt_instance, targets):
    ...
    for idx,target_name in enumerate(targets):
        ...
        if target_name in opt_instance.fwd_sim_obj['chambers'][0]['values']:
            ...
            x0.append(opt_instance.fwd_sim_obj['chambers'][1]['values'][target_name])
...
if __name__== "__main__":
    ...
    if run_opt:
        ...
        var_to_opt = ["flow:vessel_aorta:OUTLET_AORTA", "pressure:vessel_aorta:OUTLET_AORTA", "flow:vessel_rpa:OUTLET_RPA", "pressure:vessel_rpa:OUTLET_RPA", "flow:vessel_lpa:OUTLET_LPA", "pressure:vessel_lpa:OUTLET_LPA"]    
        plot_vars = ["flow:vessel_aorta:OUTLET_AORTA", "pressure:vessel_aorta:OUTLET_AORTA", "flow:vessel_rpa:OUTLET_RPA", "pressure:vessel_rpa:OUTLET_RPA", "flow:vessel_lpa:OUTLET_LPA", "pressure:vessel_lpa:OUTLET_LPA"]    

        targets_all = ['Rd', 'Rp', 'C']

        bounds_all = {'Emax'    : [0.0, 1e7], 
                      'Emin'    : [0.0, 1e5], 
        ...
        targets = ['Rd', 'Rp', 'C']
        optimizer.variables_to_opt = ["flow:vessel_aorta:OUTLET_AORTA", "pressure:vessel_aorta:OUTLET_AORTA"]
        ...
        targets = ['Rd', 'Rp', 'C']
        optimizer.variables_to_opt = ["flow:vessel_rpa:OUTLET_RPA", "pressure:vessel_rpa:OUTLET_RPA"]
        result = run_optimization(optimizer, targets)
        print("result = ", result)
        optimizer.print_summary(targets_all)
        optimizer.plot('after chamber')
        ...
        targets = ['Rd', 'Rp', 'C']
        optimizer.variables_to_opt = ["flow:vessel_lpa:OUTLET_LPA", "pressure:vessel_lpa:OUTLET_LPA"]
