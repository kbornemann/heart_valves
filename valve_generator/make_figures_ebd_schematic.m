...
if tangent_mod_plots 
    ...
    view(az,el);
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic');
    ...
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic_annulus_view');
    ...
    view(az,el)
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic_side_view');
...
if tangent_mod_plots_reference
    ...
    view(az,el);
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic_quad');
    ...
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic_annulus_view_quad');
    ...
    view(az,el)
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic_side_view_quad');

    az = -180;
    el = 90;

    view(az,el)
    print(fig, '-dpng', 'circ_tangent_mod_aortic_schematic_top_quad');
