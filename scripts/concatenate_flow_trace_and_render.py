    ...
    if os.path.isfile('done.txt'):
        ...
        for f in os.listdir('.'):
            if f.startswith('viz'): 
                ...
                code = subprocess.call('cp ~/heart_valves_preop/scripts/run_aortic_plots.m .', shell=True)
                if code is None:
                ...
                call_str_concatenate = 'python ~/heart_valves_preop/scripts/concatenate_jpegs.py '
